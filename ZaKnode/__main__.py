...
def run():
    ...
    desc1 = nodes.Label(default, "Use space to switch scenes", my_game.fonts["main"], offset_str="center")
    ...
    desc = nodes.TextBlock(scene1, "Dragging the green hitbox moves parent node and all inside it", my_game.fonts["secondary"], offset_str="bottom")
    ...
    desc2 = nodes.TextBlock(scene2, "Image loading and move with arrows", my_game.fonts["main"], offset_str="top", txt_color = (0, 0, 0), bg_color = (255, 255, 255), padding = 25)
    ...
    desc3 = nodes.TextBlock(scene3, "2 animations from 1 tile map", my_game.fonts["secondary"], offset_str = "top", txt_color = (0, 0, 0), bg_color = (255, 255, 255), padding = 15)
    desc4 = nodes.TextBlock(scene3, "Sorted by z-index and moves on mouse click", my_game.fonts["secondary"], offset = desc3.offset + Vector2(0, 120), txt_color = (200, 200, 240), bg_color = (12, 12, 12), padding = 25)
